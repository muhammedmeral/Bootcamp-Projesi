...
{
    public float dakika = 5; // 1. oyundaki dakikayý belirtecek deðiþken
    ...
    //AudioSource audioSource;  //Oyundaki genel ambiyans sesi.    //+++++++
    //public AudioClip genelAmbiyans; +++++
    ...
    private void Update()
    {
        ...
        if (zamanSayaci != null)
        {
            ...
            if (dakika <= 1 && spawnLock == 0) //süre 2 dakikanýn altýna düþtüðünde canavarýn ortaya çýkmasý saðlanacak.
            {
